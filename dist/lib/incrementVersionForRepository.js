...
async function incrementVersionForRepository(gitUrl, type) {
    switch (type) {
        case "major":
        case "minor":
        case "patch":
    ...
    const versions = await (0, ls_1.default)(gitUrl);
    if (versions.length === 0) {
        return (0, setDefaultVersion_1.default)(type);
    }
    const highest = (0, findHighestVersion_1.default)(versions);
    const newVersion = (0, incrementVersion_1.default)(highest, type);
    (0, setVersion_1.setVersion)(newVersion, highest.version);
}

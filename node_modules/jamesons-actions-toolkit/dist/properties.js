...
function parsePropertiesOfFile(path) {
    return __awaiter(this, void 0, void 0, function* () {
        return parseProperties((yield (0, promises_1.readFile)(path)).toString());
    });
}
...
function savePropertiesToFile(path, properties) {
    return __awaiter(this, void 0, void 0, function* () {
        yield (0, promises_1.writeFile)(path, stringifyProperties(properties));
    });
}
...
function savePropertiesToEnvFile(key, properties) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield savePropertiesToFile(process.env[key], properties);
    });
}
exports.savePropertiesToEnvFile = savePropertiesToEnvFile;
function appendPropertiesToFile(path, properties) {
    return __awaiter(this, void 0, void 0, function* () {
        yield (0, promises_1.appendFile)(path, stringifyProperties(properties));
    });
}
...
function appendPropertiesToEnvFile(key, properties) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield appendPropertiesToFile(process.env[key], properties);
    });
}
